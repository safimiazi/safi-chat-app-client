                ...
                <Stack spacing={2}>
                    <Stack p={2} spacing={3} alignItems={"center"} sx={{ backgroundColor: theme.palette.background.paper, borderRadius: 1 }}>
                        ...
                        <Stack spacing={2}>
                            ...
                            <Typography variant="subtitle2" sx={{ color: theme.palette.main }} component={Link} to="https://www.youtube.com/">www.youtube.com</Typography>
                        </Stack>
        ...
        <>
            ...
            >
                <Stack spacing={1} px={1}>
                    {Message_options.map((el) => <MenuItem onClick={handleClick}>{el.title}</MenuItem>)}
